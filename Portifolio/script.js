const home = '<div class="homeHeader-container">'
  +'<h1 class="nameTitle">Rafael Azevedo</h1>'
  +'<h4 class="subtitle-home">Full Stack Web development student at Trybe</h4>'
+'</div>'
+'<h4>My Projects</h4>'
+'<div class="my-projects">'
  +'<a class="link-project" href="https://rafaelbiatoazevedo.github.io/SiteBrothers/" target="_blank">'
    +'<div class="container-logos-home">'
      +'<img class="logoBrothers" src="./imagens/logo-brothers.png" alt="logo-brothers"/>'
      + '<div class="container-logos-tecno">'
        +'<img class="tecnoIcon" src="./icones/Html5.ico" alt="Teconology Icon" />'
        +'<img class="tecnoIcon" src="./icones/CSS3.png" alt="Teconology Icon" />'
        +'<img class="tecnoIcon" src="./icones/JavaScript.jpg" alt="Teconology Icon" />'
      +'</div>'
    +'</div>'
  +'</a>'
  +'<a class="link-project" href="https://rafaelbiatoazevedo.github.io/Site-Rafa-Express/" target="_blank">'
    +'<div class="container-logos-home">'
    +'<img class="logoRafaexpress" src="./imagens/logoRafaExpressWhite.png" alt="logo-rafaexpress"/>'
      + '<div class="container-logos-tecno">'
        ...
        +'<img class="tecnoIcon" src="./icones/CSS3.png" alt="Teconology Icon" />'
        +'<img class="tecnoIcon" src="./icones/JavaScript.jpg" alt="Teconology Icon" />'
        +'<img class="tecnoIcon" src="./icones/React.png" alt="Teconology Icon" />'
        +'<img class="tecnoIcon logo-redux" src="./icones/Redux.png" alt="Teconology Icon" />'
      +'</div>'
  +'</div>'
  +'</a>'
+'</div>'
...
+'<div class="container-project-trybe">'
  ...
  +'  <option class="opt-test">Choose project</option>'
  ...
  +'<select>'
  +'<a class="link-home" href="https://github.com/RafaelBiatoAzevedo/RafaelBiatoAzevedo.github.io/tree/main/Projects" target="_blank">'
    +'<img class="link-logo-github" src="./imagens/logo_github.png" alt="logo-gihub"/>'
...
+'<div class="container-certificates">'
  +'<a class="link-certificate" href="./certificates/RafaelModulo1.pdf" target="_blank">'
    ...
    +'<p class="text-certificate">Fundamentos de Desenvolvimento Web</p>'
  +'</a>'
  + '<a class="link-certificate" href="./certificates/ModuloFrontEnd.pdf" target="_blank">'
    +'<img class="img-certificate" src="./imagens/certificateModuloFronEnd.jpeg" width="200px" alt="certificate1" />'
    +'<p class="text-certificate">Desenvolvimento Front End</p>'
  +'</a>'
+'</div>';
...
+'<div class="links-container">'
  +'<a class="link" href="https://www.linkedin.com/in/rafael-azevedo-530889195/" target="_blank">'
    +'<img class="link-logo-linkid" src="./imagens/logo_linke.png" alt="logo-linke"/>'
    +'<p class="text-linkedin">LinkedIn</p>'
  +'</a>'
  +'<a class="link" href="https://github.com/RafaelBiatoAzevedo" target="_blank">'
    +'<img class="link-logo-github" src="./imagens/logo_github.png" alt="logo-gihub"/>'
    +'<p class="text-github">GitHub</p>'
  +'</a>'
  +'<a class="link" href="https://www.instagram.com/rafael_azevedo_55/" target="_blank">'
    +'<img class="link-logo-insta" src="./imagens/logo_insta.png" alt="logo-insta"/>'
    +'<p class="text-instagram">Instagram</p>'
  +'</a>'
+'</div>';
